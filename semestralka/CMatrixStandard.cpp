...
CMatrixStandard * CMatrixStandard::Add(const unique_ptr<CMatrix> & other) const {
...
CMatrixStandard * CMatrixStandard::NegateAllNums() const{
...
CMatrixStandard * CMatrixStandard::Multiply (const unique_ptr<CMatrix> & other) const{
